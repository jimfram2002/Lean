...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class FutureMarginBuyingPowerModelTests
    {
        ...
        public void TestMarginForSymbolWithOneLinerHistory()
        {
            ...
            Assert.AreEqual(buyingPowerModel.IntradayMarginRequirement, buyingPowerModel.GetMaintenanceMargin(futureSecurity));
        }
        ...
        public void TestMarginForSymbolWithHistory()
        {
            ...
            var buyingPowerModel = new TestFutureMarginModel(futureSecurity);
            Assert.AreEqual(buyingPowerModel.IntradayMarginRequirement,
        ...
        public void GetMaintenanceMargin(decimal quantity)
        {
            ...
            Assert.AreEqual(buyingPowerModel.IntradayMarginRequirement * futureSecurity.Holdings.AbsoluteQuantity, res);
        ...
        public void IntradayVersusOvernightMargins(decimal target)
        {
            ...
            futureSecurity.Holdings.SetHoldings(100, quantityClosedMarket * 10);
